...
import { SimulationConfig, ModelType, SimulationMode } from '../types';
      ...
      <div className="flex flex-col md:flex-row items-center gap-3 pt-3 border-t border-slate-100">
        ...
        <div className="flex flex-col gap-2 w-full md:w-auto">
          <div className="flex items-center gap-2 w-full md:w-auto">
            <button 
              onClick={() => onRunSimulation('simulation')}
            ...
            <button 
              onClick={() => onRunSimulation('review')}
              className="flex-1 md:w-36 bg-indigo-600 hover:bg-indigo-700 text-white text-[11px] font-black py-3 rounded-xl shadow-lg shadow-indigo-200 flex items-center justify-center gap-2 transition-all transform active:scale-95 uppercase tracking-wider"
            >
          ...
          <button 
            onClick={onSeeData}
            className="w-full bg-emerald-600 hover:bg-emerald-700 text-white text-[11px] font-black py-3 rounded-xl shadow-md flex items-center justify-center gap-2 transition-all transform active:scale-95 uppercase tracking-wider"
          >
